...
def build_prompt(agent: AgentConfig, task_desc: str, target_content: str,
                 ...
                 history: List[str], experiment_num: int) -> List[dict]:
    ...
    system = f"""You are {agent.name}, an AI research agent in a swarm optimization team.
...
6. Keep the output clean: no extra commentary after the ``` markers.{failed_block}"""
